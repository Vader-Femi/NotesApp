...
import com.nosa.notesapp.adapters.RvNotesAdapter
import com.nosa.notesapp.databinding.FragmentNoteBinding
import com.nosa.notesapp.utils.SwipeToDelete
...
class NoteFragment : Fragment(R.layout.fragment_note) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //implement search
        noteBinding.search.addTextChangedListener(
            object : TextWatcher {
        ...
        val swipeToDeleteCallback = object : SwipeToDelete() {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                val snackBar = Snackbar.make(
                    requireView(), "Note Deleted", Snackbar.LENGTH_SHORT
